...
const translations = {
    en: {
        ...
        data_info_label: 'Within this section, you can review and upload the required documents to complete your profile as a supplier. Each document has a status indicating its progress and current state. Please ensure to provide all necessary documents and keep track of their status to successfully complete your supplier profile.',
        ...
        state_title: 'Document states',
        state_1: 'Confirmed state',
        state_2: 'Pending state',
        state_3: 'Under review state',
        state_4: 'Rejected state',
        state_5: 'Upload pending state',
    ...
    es: {
        ...
        data_info_label: 'En esta sección, puede revisar y cargar los documentos necesarios para completar su perfil como proveedor. Cada documento tiene un estado que indica su progreso y estado actual. Por favor, asegúrese de proporcionar todos los documentos necesarios y mantener un seguimiento de su estado para completar exitosamente su perfil como proveedor.',
        ...
        state_title: 'Estado del documento',
        state_1: 'Estados confirmados',
        state_2: 'Estados pendientes',
        state_3: 'Estados en revisión',
        state_4: 'Estados rechazados',
        state_5: 'Estados pendientes de carga',
