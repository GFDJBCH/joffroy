...
const translations = {
    en: {
        ...
        requested_documentation: 'Requested documentation',

        current_page_title_1: 'Last activity',
        current_page_title_2: 'Documents',
    ...
    es: {
        ...
        requested_documentation: 'Documentación solicitada',

        current_page_title_1: 'Última actividad',
        current_page_title_2: 'Documentos',
